...
"""
    ...
    # Add to builtin_functions
    def add_ai_streamlit_functions():
        builtin_functions.update({
            'create_ai_streamlit_app': create_ai_streamlit_app,
            'create_ai_chat_app': create_ai_chat_app,
        })
    add_ai_streamlit_functions()

    # AI Image Classification Functions
